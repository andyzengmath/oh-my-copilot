...
Invoke the Claude CLI directly from a shell tool with non-interactive flags:
...
Do not silently fall back to another model — the user invoked this skill specifically to consult Claude.

## Artifact requirement
After local execution, save a markdown artifact to:

```text
.omghc/artifacts/claude-<slug>-<timestamp>.md
```
